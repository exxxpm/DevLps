    ...
    <main>
        ...
        <div class="sCreateObject__body">
            <div class="sCreateObject__left-side">
                <h2>Создание квартиры</h2>
                <div class="form-wrap">
                    <div class="form-wrap__main-row row">
                        <div class="col-12">
                            <div class="custom-input-wrap form-group">
                                <?= $form->field($flat, 'name')->textInput(['class' => 'custom-input-wrap__input form-control', 'placeholder' => 'Введите название'])->label(false); ?>
                                <div class="custom-input-wrap__line"></div>
                            </div>
                        </div>
                        <div class="col-12">
                            <div class="form-wrap__input-wrap form-group">
                                <?= $form->field($flat, 'description')->textarea(['class' => 'form-wrap__input form-control', 'placeholder' => 'Введите описание объекта'])->label(false); ?>
                            </div>
                            <!-- +e.input-wrap-->
                        </div>
                    </div>
                    ...
                    <div class="col-12">
                        <div class="sCreateObject__item">
                            ...
                            <div class="sCreateObject__date dateSingle-js">
                                ...
                                <?= $form->field($flat, 'date_start', ['errorOptions' => ['style' => 'display:none;']])->hiddenInput(['class' => 'hidden_date-create'])->label(false); ?>
                            </div>
                            <?php foreach ($flat->getErrors('date_start') as $error): ?>
                    ...
                    <div class="col-12">
                        <div class="sCreateObject__item">
                            ...
                            <div class="sCreateObject__date dateSingle-js">
                                ...
                                <?= $form->field($flat, 'date_finish', ['errorOptions' => ['style' => 'display:none;']])->hiddenInput(['class' => 'hidden_date-finish'])->label(false); ?>
                            </div>
                            <?php foreach ($flat->getErrors('date_finish') as $error): ?>
        ...
        <div class="sCreateObject__footer">
            <div class="sCreateObject__footer-row">
                ...
                <a class="sCreateObject__btn btn btn-light" href="/web/floor/index/<?= $id ?>">Отмена</a>
            </div>
        </div>
        <?php ActiveForm::end(); ?>
        <!-- end sCreateObject-->
        <a href="/web/floor/index/<?= $id ?>" class="close-btn">

    ...
    <main>
        ...
        <div class="sCreateObject__body">
            ...
            <div class="sCreateObject__right-side">
                <div class="sCreateObject__row row">
                    ...
                    <div class="col-12">
                        <div class="sCreateObject__item">
                            <p>Дата создания</p><span><?= Yii::$app->formatter->asDate($flat->create, 'd.M.Y H:i'); ?></span>
                        </div>
                    </div>
                    <div class="col-12">
                        <div class="sCreateObject__item">
                            <p>Последнее изменение</p><span><?= Yii::$app->formatter->asDate( $flat->last_update, 'd.M.Y H:i'); ?></span>
                        </div>
                    </div>
                    <div class="col-12">
        ...
        <div class="sCreateObject__footer">
            <div class="sCreateObject__footer-row">
                ...
                <a class="sCreateObject__btn btn btn-light" href="/web/flat/index/<?= $id ?>">Отмена</a>
            </div>
        </div>
        <?php ActiveForm::end(); ?>
        <!-- end sCreateObject-->
        <a href="/web/flat/index/<?= $id ?>" class="close-btn">

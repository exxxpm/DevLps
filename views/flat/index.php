        ...
        <div class="page-head">
            <div class="container-fluid">
                <div class="page-head__row row align-items-center">
                    <div class="col">
                        <?
                        $breadcrumbsLinks = [['label' => $object->name, 'url' => '/web/site/object/' . $object->id], ['label' => $home->name, 'url' => '/web/home/index/' . $home->id], ['label' => $entrance->name, 'url' => '/web/entrance/index/' . $entrance->id], ['label' => $floor->name, 'url' => '/web/floor/index/' . $floor->id], ['label' => $flat->name]];
                    ...
                    <div class="page-head__col col-md-auto order-md-2">
                        <a class="page-head__edit" href="/web/flat/edit/<?= $id ?>">Редактировать

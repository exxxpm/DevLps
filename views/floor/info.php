...
<div class="main-center-wrap">
    <main>
        <?= $this->render('_header', compact('floor',  'id')); ?>
        <!-- start sMainInfo-->
                    ...
                    <div class="toggle-block swiper freeMode-slider freeMode-slider--js">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <a class="toggle-block__btn btn btn-outline-light <? if (Yii::$app->controller->action->id == 'index') {echo "active";} else {echo "";} ?>" href="/web/floor/index/<?= $id ?>">
                            ...
                            <div class="swiper-slide">
                                <a class="toggle-block__btn btn btn-outline-light <? if (Yii::$app->controller->action->id == 'task') {echo "active";} else {echo "";} ?>" href="/web/floor/task/<?= $id ?>">
                            ...
                            <div class="swiper-slide">
                                <a class="toggle-block__btn btn btn-outline-light <? if (Yii::$app->controller->action->id == 'work-schedule') {echo "active";} else {echo "";} ?>" href="/web/floor/work-schedule/<?= $id ?>">
                            ...
                            <div class="swiper-slide">
                                <a class="toggle-block__btn btn btn-outline-light <? if (Yii::$app->controller->action->id == 'info') {echo "active";} else {echo "";} ?>" href="/web/floor/info/<?= $id ?>">
                            ...
                            <div class="swiper-slide">
                                <a class="toggle-block__btn btn btn-outline-light <? if (Yii::$app->controller->action->id == 'notes') {echo "active";} else {echo "";} ?>" href="/web/floor/notes/<?= $id ?>">
                    ...
                    <div class="row row--xxl" style="--bs-gutter-y: 18px">
                        <div class="col-md">
                            ...
                            <table class="table">
                                <tr>
                                    <td>Дата создания</td>
                                    <td class="text-end"><?= Yii::$app->formatter->asDate($floor->date_start); ?></td>
                                </tr>
                                <tr>
                                    <td>Дата окончания</td>
                                    <td class="text-end"><?= Yii::$app->formatter->asDate($floor->date_finish); ?></td>
                                </tr>
                                <tr>
                                    <td>Автор</td>
                                    <td class="text-end">

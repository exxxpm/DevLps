                    ...
                    <div class="col-12">
                        <div class="sCreateObject__item">
                            ...
                            <div class="sCreateObject__date dateSingle-js">
                                ...
                                <span class="date-create"><?= date('d', $floor->date_start) . ' ' . array_search(date('M', $floor->date_start), $months) . ' ' . date('y', $floor->date_start);?></span>
                    ...
                    <div class="col-12">
                        <div class="sCreateObject__item">
                            ...
                            <div class="sCreateObject__date dateSingle-js">
                                ...
                                <span class="date-finish"><?= date('d', $floor->date_finish) . ' ' . array_search(date('M', $floor->date_finish), $months) . ' ' . date('y', $floor->date_finish);?></span>

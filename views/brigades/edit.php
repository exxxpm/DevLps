        ...
        <div class="sCreateObject__left-side">
            ...
            <div class="form-wrap">
                <div class="form-wrap__edit-row row">
                    <div class="col-12">
                        <?= $form->field($edit_brigades, 'name', ['template' => ' <div class="custom-input-wrap form-group">{input}<div class="custom-input-wrap__line"></div>{hint}{error}</div>'])->textInput(['class' => 'custom-input-wrap__input form-control', 'placeholder' => 'Введите название'])->label(false); ?>
                    </div>
                    <div class="col-12">
                        <div class="form-wrap__wrap">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md">
                                    ...
                                    ?>
                                    <?= $form->field($edit_brigades, 'surfaces', ['template' => '{input}'])->checkboxList(
                                        $options,
                                        [
                            ...
                            <div class="row">
                                ...
                                <div class="col-md">
                                    ...
                                    ?>
                                    <?= $form->field($edit_brigades, 'works', ['template' => '{input}'])->checkboxList(
                                        $options,
                                        [
                                            'item' => function ($index, $label, $name, $checked, $value) {
                                                return "<label class='custom-input form-check'>" .
                    ...
                    <div class="col-12">
                        <div class="form-wrap__wrap" id="workers_container">
                            <h4>Работники</h4>
                            <? for($worker_count = 0; $worker_count < count($edit_brigades->names); $worker_count++){?>
                                <div class="row" id="workers_card">
                                    <div class="form-wrap__title-col col-md-auto">
                                       <span id="worker_title">Работник <?=$worker_count+1?></span>
                                        <? if ($worker_count > 0) { ?>
                                    ...
                                    <div class="col-md">
                                        <div class="form-wrap__worker-wrap">
                                            <div class="form-wrap__input-wrap form-group">
                                                <?= $form->field($edit_brigades, 'names[]', ['template' => "{label}\n{input}\n<span class=\"form-wrap__input-title\">ФИО</span>\n{hint}\n{error}"])->textInput(['class' => 'form-wrap__input form-control', 'placeholder' => 'ФИО', 'value' => $edit_brigades->names[$worker_count]])->label(false); ?>
                                            </div>
                                            <div class="form-wrap__input-wrap form-group">
                                                <?= $form->field($edit_brigades, 'phones[]', ['template' => "{label}\n{input}\n<span class=\"form-wrap__input-title\">Телефон</span>\n{hint}\n{error}"])->textInput(['class' => 'form-wrap__input form-control', 'placeholder' => 'Телефон', 'value' => $edit_brigades->phones[$worker_count]])->label(false); ?>
                                            </div>
                                        </div>
                                        <? if ($worker_count == count($edit_brigades->names) - 1) { ?>

                    ...
                    <div class="col-12">
                        <div class="sCreateObject__item">
                            ...
                            <div class="sCreateObject__date dateSingle-js">
                                ...
                                <?= $form->field($room, 'date_start', ['errorOptions' => ['style' => 'display:none;']])->hiddenInput(['class' => 'hidden_date-create'])->label(false); ?>
                            </div>
                            <?php foreach ($room->getErrors('date_start') as $error): ?>
                    ...
                    <div class="col-12">
                        <div class="sCreateObject__item">
                            ...
                            <div class="sCreateObject__date dateSingle-js">
                                ...
                                <?= $form->field($room, 'date_finish', ['errorOptions' => ['style' => 'display:none;']])->hiddenInput(['class' => 'hidden_date-finish'])->label(false); ?>
                            </div>
                            <?php foreach ($room->getErrors('date_finish') as $error): ?>

...
<div class="main-center-wrap">
    <main>
        <?= $this->render('_header', compact('room', 'id')); ?>
        <!-- start sMainInfo-->
                    ...
                    <div class="row row--xxl" style="--bs-gutter-y: 18px">
                        <div class="col-md">
                            ...
                            <table class="table">
                                <tr>
                                    <td>Дата создания</td>
                                    <td class="text-end"><?= Yii::$app->formatter->asDate($room->date_start); ?></td>
                                </tr>
                                <tr>
                                    <td>Дата окончания</td>
                                    <td class="text-end"><?= Yii::$app->formatter->asDate($room->date_finish); ?></td>
                                </tr>
                                <tr>
                                    <td>Автор</td>
                                    <td class="text-end">

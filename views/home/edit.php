        ...
        <div class="sCreateObject__body">
            ...
            <div class="sCreateObject__right-side">
                <div class="sCreateObject__row row">
                    ...
                    <div class="col-12">
                        <div class="sCreateObject__item">
                            ...
                            <div class="sCreateObject__date dateSingle-js">
                                ...
                                <span class="date-create"><?= date('d', $home->date_start) . ' ' . array_search(date('M', $home->date_start), $months) . ' ' . date('y', $home->date_start);?></span>
                    ...
                    <div class="col-12">
                        <div class="sCreateObject__item">
                            ...
                            <div class="sCreateObject__date dateSingle-js">
                                ...
                                <span class="date-finish"><?= date('d', $home->date_finish) . ' ' . array_search(date('M', $home->date_finish), $months) . ' ' . date('y', $home->date_finish);?></span>
                    ...
                    <div class="col-12">
                        <div class="sCreateObject__item">
                            <p>Дата создания</p><span><?= Yii::$app->formatter->asDate($home->create, 'd.M.Y H:i'); ?></span>
                        </div>
                    </div>
                    <div class="col-12">
                        <div class="sCreateObject__item">
                            <p>Последнее изменение</p><span><?= Yii::$app->formatter->asDate( $home->last_update, 'd.M.Y H:i'); ?></span>
                        </div>
                    </div>
                    <div class="col-12">
